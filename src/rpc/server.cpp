...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIVX features */
        {"sbrc", "listmasternodes", &listmasternodes, true, true, false},
        {"sbrc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sbrc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sbrc", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"sbrc", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"sbrc", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"sbrc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sbrc", "masternodedebug", &masternodedebug, true, true, false},
        {"sbrc", "startmasternode", &startmasternode, true, true, false},
        {"sbrc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sbrc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sbrc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sbrc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sbrc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sbrc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sbrc", "preparebudget", &preparebudget, true, true, false},
        {"sbrc", "submitbudget", &submitbudget, true, true, false},
        {"sbrc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sbrc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sbrc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sbrc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sbrc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sbrc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sbrc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sbrc", "checkbudgets", &checkbudgets, true, true, false},
        {"sbrc", "mnsync", &mnsync, true, true, false},
        {"sbrc", "spork", &spork, true, true, false},
...
{
    return "> sbrc-cli " + methodname + " " + args + "\n";
}
