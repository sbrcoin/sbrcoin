...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 SBRC
    MAKE_SPORK_DEF(SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT,  1609678358), // OFF
    MAKE_SPORK_DEF(SPORK_9_MASTERNODE_BUDGET_ENFORCEMENT,   1609678358), // OFF
    MAKE_SPORK_DEF(SPORK_13_ENABLE_SUPERBLOCKS,             1609678358), // OFF
	...
	MAKE_SPORK_DEF(SPORK_21_COLDSTAKING_ENFORCEMENT,        1609678358), // OFF
	MAKE_SPORK_DEF(SPORK_22_BAN_DUPLICATE_MN_PER_IP,        1609678358), // OFF
	MAKE_SPORK_DEF(SPORK_24_ENFORCE_NEW_MN_CHECKS,          1609678358), // OFF
	};
