...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SBRC Core sbrc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sbrc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sbrc transaction") + "\n" +
                               "  sbrc-tx [options] -create [commands]   " + _("Create hex-encoded sbrc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sbrc transaction
