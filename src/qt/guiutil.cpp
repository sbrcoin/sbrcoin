...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter SBRC address (e.g. %1)").arg("7mphVWRT43hdZ9zncvPRgA94tuL2dvFXCL"));
...
{
    // return if URI is not valid or is no SBRC: URI
...
bool openConfigfile()
{
    ...
    /* Open sbrc.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Sbrc.lnk";
}
...
{
    return GetAutostartDir() / "sbrc.desktop";
}
