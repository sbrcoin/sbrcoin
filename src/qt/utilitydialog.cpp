                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("SBRC") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("SberCoin is shutting down...") + "<br /><br />" +
        tr("Do not shut down the computer until this window disbrcears.")));
    setLayout(layout);
}
