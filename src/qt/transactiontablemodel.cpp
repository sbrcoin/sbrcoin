...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("SBRC Stake");
    case TransactionRecord::StakeZPIV:
        return tr("zSBRC Stake");
    case TransactionRecord::StakeDelegated:
        return tr("SBRC Cold Stake");
    case TransactionRecord::StakeHot:
        return tr("SBRC Stake on behalf of");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted SBRC to zSBRC");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zSBRC");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received SBRC from zSBRC");
    case TransactionRecord::ZerocoinSpend_Change_zPiv:
        return tr("Minted Change as zSBRC from zSBRC Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zSBRC to SBRC");
    default:
        return QString();
    }
}
