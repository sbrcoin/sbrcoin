    ...
    ui(new Ui::DashboardWidget)
{
    ...
    ui->labelMessage->setText(tr("Amount of SBRC earned via Staking & Masternodes"));
    ...
    ui->labelAmountPiv->setText("0 SBRC");
	ui->labelAmountMNRewards->setText("0 SBRC");
...
void DashboardWidget::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("SBRC")
    updateDisplayUnit();
}
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair SBRC, zSBRC
...
void DashboardWidget::onChartRefreshed()
{
    ...
    // init sets
    set0 = new QBarSet("SBRC");
	set1 = new QBarSet("SBRC MN Rewards");
