...
# Create zip file of binaries
	cp SBRC/src/sbrcd SBRC/src/sbrc-cli SBRC/src/sbrc-tx SBRC/src/qt/sbrc-qt .
	zip SBRC-Linux.zip sbrcd sbrc-cli sbrc-tx sbrc-qt
	rm -f sbrcd sbrc-cli sbrc-tx sbrc-qt
